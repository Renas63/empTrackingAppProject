...
public class EmployeeAppRunner {
    static HRDepartment hrDepartment=new HRDepartment("Chicago","Techtorial");
    ...
    public static  Employee createAccount(Scanner scanner){
        ...
        System.out.println("please e nter your title");
        ...
        return new Employee(firstName,lastName,emailAddress,phoneNumber,title,departmentName,startingDate);
    }
    ...
    private static void makeAChoice(String choice){
        switch (choice){
            ...
            case "1":
                Scanner scanner=new Scanner(System.in);
                Employee emp= createAccount(scanner);
                hrDepartment.addEmployee(emp);
